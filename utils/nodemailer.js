  ...
  try {
    const info = await transport.sendMail({
      ...
      html: `<div>
            ...
            <a href=https://server-foodkart.onrender.com/user_auth/reset_password/${resetPasswordCode}>
            ...
            <br/>
            <br/>
            <p style="line-height: 1.5">If you did not make this request, please ignore this email. <br /><br />Best regards, <br />Team FoodKart.</p>
            </div>`
    });
