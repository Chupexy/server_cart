...
router.post('/edit_profile', async(req, res)=>{
    ...
    try{
        ...
        //get admin document
        let Madmin = await Admin.findOne({_id: admin._id, is_deleted: false}, {fullname: 1, phone_no: 1, email: 1, role: 1}).lean()
...
router.post('/delete_admin', async(req, res)=>{
    ...
    try {
        ...
        //update admin document
        await Admin.findOneAndUpdate({_id: admin_id}, {is_deleted: true}, {new: true}).lean()
